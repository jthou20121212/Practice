    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntentParams()) {
            setContent("---\n" +
                    ...
                    "| 对比维度       | 豆包表现                         | 千问表现                         |\n" +
                    "| ---------------- | ---------------------------------- | ---------------------------------- |\n" +
                    "| 大众场景适配度 | 覆盖90%普通用户高频需求，响应自然接地气 | 侧重专业/开发场景，日常需求匹配度偏低 |\n" +
                    "| 响应效率       | 简单问题平均响应0.5秒，指令理解准确率83% | 简单问题平均响应214毫秒，偶尔出现指令理解偏差 |\n" +
                    "| 内容创作能力   | 中文网感突出，短视频脚本、自媒体文案可直接使用 | 内容风格偏严谨，生活化创作适配性弱 |\n" +
                    "| 用户规模       | 月活1.72亿，依托字节系生态获客成本低，用户基数大 | 月活2572万，用户规模存在数量级差距 |\n" +
                    "| 免费政策友好度 | Lite/Mini版全免费，覆盖90%日常需求 | 核心专业功能免费，但生态联动场景有限 |\n" +
                    "---");
        }
    }
